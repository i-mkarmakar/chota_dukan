      ...
      <div className="h-48 rounded-xl relative">
        {editable && (
          <>
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute top-16 right-4 z-10 rounded-full bg-background/70 backdrop-blur-md hover:bg-background/100 transition-all duration-300 ease-in-out"
              onClick={() =>
        ...
        <div className="absolute -bottom-16 left-8">
          <Avatar
            ...
            onClick={() =>
              handleOpenPreview(user?.imageUrl || "/placeholder.svg", "avatar")
            }
          >
